...
import { Building2, Mail, Lock, Eye, EyeOff, ArrowRight, ShieldCheck, Home } from "lucide-react";
...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(false);
    if (res.ok) navigate(res.role === "tenant" ? "/tenant" : "/", { replace: true });
    else setError(res.error);
  }

  return (
    <div className="min-h-screen flex bg-stone-50 dark:bg-stone-950">
      {/* Left panel – Luxury Background with Original Details */}
